...
# input_dir <- '~/Documents/bhklab/jakstat/tcl38/snakemake/acgh'
# output_dir <- '~/Documents/bhklab/jakstat/tcl38/snakemake/multiassay'
...
df_list <- list()
for(file in files){
  lines <- readLines(file.path(acgh_dir, file), warn = FALSE)
